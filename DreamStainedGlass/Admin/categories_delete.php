<?php
  ...
  */
  if(isset($_POST['delete'])) {
    ...
    $delete = "DELETE FROM categories_cat WHERE id_cat='$cat_id'"; 
    ...
    if($run_delete) {
      ...
      header('location:categories_delete.php');
      exit(0);
    }else{
...
<section class="my-5 py-5">
  ...
  <div class="container">
    <a class="g-btn" href="categories.php">Go back to table</a>
    <hr>
  </div>
