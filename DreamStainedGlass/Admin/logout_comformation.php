...
<!-- Imported Public Header -->  
  ...
  <?php 
    ...
    <hr>
    <div>
      <a href ="../private/logout.php" class="g-btn col-3 d-grid mx-auto p-3" class="">Logout</a>
      <a href ="admin_dashboard.php" class="g-btn col-3 d-grid mx-auto p-3" class="">No</a>
